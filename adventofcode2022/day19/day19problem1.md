...
collection of [geodes](https://en.wikipedia.org/wiki/Geode) around the pond. Perhaps you could use the obsidian to 
...
Finally, if you add up the quality levels of all of the blueprints in the list, 
you get **`33`**.
